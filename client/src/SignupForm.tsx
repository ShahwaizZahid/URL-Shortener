...
import { type SignupData } from "./context/AuthProvider";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className="w-full h-20 flex flex-col mt-2 
          ...
          >
            ...
            <input
              className={`
              outline-none   border-2 px-5 ml-8 py-2 ${
                checked
                  ? "text-white bg-black border-white"
                  : "text-black bg-white border-black"
              }`}
            ...
            />
            {errors.name && (
              <div className="text-sm ">{errors.name.message}</div>
            )}
          </div>
